    ...
    <div id="main-container" class="h-screen w-screen flex flex-col transition-all duration-500 bg-customBg bg-cover bg-center bg-fixed overflow-hidden" 
      ...
      <div class="flex-1 w-full grid grid-cols-1 md:grid-cols-[22%_56%_22%] h-full overflow-hidden">
        ...
        <aside class="hidden md:flex flex-col items-center  p-8 overflow-y-auto no-scrollbar z-20">
          <div id="time-display" class="text-4xl font-bold tracking-wide tabular-nums drop-shadow-sm mb-8 ${isDark ? "text-slate-100" : "text-gray-900"}">
             ${timeStr}
          </div>
...
>
  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Right Sidebar -->
        <aside class="hidden md:flex flex-col items-center p-8 overflow-y-auto no-scrollbar z-20">
  <div class="text-4xl font-bold tracking-wide text-center leading-tight mb-8 whitespace-pre-line ${isDark ? "text-slate-100" : "text-gray-900"}">${dateStr}</div>
